...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'mods_name_displayForm_aut_ms', :label => 'Additional Author(s)'
    config.add_index_field 'mods_name_displayForm_cre_ms', :label => 'Additional Creator(s)'
    config.add_index_field 'mods_name_displayForm_pht_ms', :label => 'Additional Photographer(s)'
    config.add_index_field 'mods_name_displayForm_ctb_ms', :label => 'Contributor'
    config.add_index_field 'mods_name_displayForm_scr_ms', :label => 'Scribe'
    ...
    config.add_show_field 'mods_identifier_type_hdl_ms', :label => 'Persistent Record Link'
    ...
    config.add_show_field 'mods_name_displayForm_aut_ms', :label => 'Additional Author(s)'
    config.add_show_field 'mods_name_displayForm_cre_ms', :label => 'Additional Creator(s)'
    config.add_show_field 'mods_name_displayForm_pht_ms', :label => 'Additional Photographer(s)'
    ...
    config.add_show_field 'mods_name_displayForm_scr_ms', :label => 'Scribe'
